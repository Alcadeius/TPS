<div>
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                ...
                <a href="{{route('browse')}}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Browse Jobs</a>
  ...
  <div id="clos" class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Improve your Experience and Earn Money</h2>
        <p class="mt-6 text-lg leading-8 text-gray-300">Make Your Portfolio better and make a good relationship with customer</p>
      </div>
      <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
        <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="flex flex-col-reverse">
            ...
            <dd class="text-2xl font-bold leading-9 tracking-tight text-white">Rp10.000.000</dd>
          </div>
        </dl>
      </div>
    </div>
  ...
  <div class="bg-white">
    <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-14">
      <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-10 lg:px-24 lg:pt-0">
        ...
        <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300">Connect To everyone on this region and shared the experience to others</p>
          <div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
            <a href="#" class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Get started</a>
          </div>
        </div>
        <div class="relative mt-16 h-80 lg:mt-8">
          <img class="absolute left-0 top-0 w-[57rem] max-w-none rounded-md bg-white/5 ring-1 ring-white/10" src="{{asset("storage/background.jpg")}}" alt="App screenshot" width="1824" height="1080">
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
        <div class="lg:pr-8 lg:pt-4">
          <div class="lg:max-w-lg">
            <h2 class="text-base font-semibold leading-7 text-indigo-600">Earn Money faster</h2>
            <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">A better Apps</p>
            <p class="mt-6 text-lg leading-8 text-gray-600">Bring you to the new way to find experience and money</p>
            <dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
              <div class="relative pl-9">
                ...
                <dd class="inline">System respons every single time for your comfortability</dd>
              </div>
              <div class="relative pl-9">
                <dt class="inline font-semibold text-gray-900">
                  <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                ...
                <dd class="inline">Never Worried about risk from transaction or lost data</dd>
              </div>
            </dl>
          </div>
        </div>
        <img src="{{asset('storage/background2.jpg')}}" alt="Product screenshot" class=" max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[29rem] md:-ml-4 lg:-ml-0">
      </div>
    </div>
  </div>
  ...
  <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <h1 class="text-white font-serif text-3xl">Hibel</h1>
        </div>
        <div class="grid grid-cols-3 lg:gap-12 sm:gap-6 sm:grid-cols-2">
            <div>
            ...
            <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                    <li class="mb-4">
                        <a href="https://github.com/themesberg/flowbite" class="hover:underline ">WhatsUp</a>
                    </li>
                    <li>
        ...
        <header class="absolute inset-x-0 top-0 z-50">
          <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="flex lg:flex-1">
                <h1 class="text-xl font-serif">Hibel</h1>
              </a>
            </div>
            
            <div class="lg:flex lg:gap-x-12">
              <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Find a Developer</a>
            ...
            <div class="lg:flex lg:flex-1 lg:justify-end">
              @if(Auth::user())
              @auth
              <a href="{{route("profile")}}" class="text-sm inline-flex justify-end font-semibold leading-6 text-gray-900">{{Auth::user()->name}}  <img class="rounded-full -mt-2 max-w-10" src="{{Auth::user()->profile ? asset('storage/storage/'.Auth::user()->profile) : asset('storage/icondef.jpg')}}" class="w-1/12 -mt-2" alt=""> <span aria-hidden="true">&rarr;</span></a>
              @endauth
              @else
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="text-center">
              <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Improve your Experience and Earn Money</h1>
              <p class="mt-6 text-lg leading-8 text-gray-600">Make Your Portfolio better and make a good relationship with customer</p>
