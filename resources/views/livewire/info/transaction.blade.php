<div>
    ...
    <script type="text/javascript"
      ...
      data-client-key="SB-Mid-client-9HzvZocXzOpNQH1b"></script>
          ...
          <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Post</h2>
              <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                  ...
                  <div class="sm:col-span-2">
                      ...
                      <textarea id="description"  disabled wire:model="desc" name="desc" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Your description here">{{$posts->desc}} </textarea>
                  </div>
                  @error('desc')
                  <div class="text-red-500">
                      {{$message}}
              ...
              <button id="pay-button" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-600 dark:focus:ring-primary-900 hover:bg-blue-800">
                  Pay
              </button>
      </div>
    </section>
